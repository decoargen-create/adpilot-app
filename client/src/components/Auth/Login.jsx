...
import { AlertCircle, Eye, EyeOff, LogIn, ArrowRight } from 'lucide-react';
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        @keyframes glowPulse {
          0%, 100% { box-shadow: 0 0 20px rgba(139,92,246,0.15), 0 4px 30px rgba(0,0,0,0.3); }
          50% { box-shadow: 0 0 40px rgba(139,92,246,0.25), 0 4px 30px rgba(0,0,0,0.3); }
        }
        @keyframes gradShift {
      ...
      {[...Array(18)].map((_, i) => (
        <div key={i} style={{
          ...
          top: `${Math.random() * 100}%`,
          background: i % 2 === 0 ? 'rgba(139,92,246,0.2)' : 'rgba(99,102,241,0.15)',
          animation: `floatP ${Math.random() * 8 + 6}s ease-in-out infinite`,
      ...
      <div style={{ position: 'relative', zIndex: 10, width: '100%', maxWidth: '410px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          ...
          <h1 style={{ color: 'white', fontSize: '28px', fontWeight: '700', margin: '0 0 4px 0' }}>
            AdPilot
          </h1>
          <p style={{ color: '#6b7280', fontSize: '14px', margin: 0 }}>
            Automatizá tus campañas de Meta Ads
          </p>
        </div>
        ...
        <div style={{
            ...
            <>
              ...
              <div style={{ position: 'relative', marginBottom: '20px' }}>
                ...
                <div style={{ position: 'relative', display: 'flex', justifyContent: 'center' }}>
                  <span style={{ padding: '0 12px', background: 'rgba(18,18,42,1)', color: '#6b7280', fontSize: '12px' }}>
                    o ingresá con email
                  </span>
                </div>
              </div>
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: '16px' }}>
              <label style={{ display: 'block', fontSize: '11px', fontWeight: '500', color: '#9ca3af', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                Correo electrónico
              </label>
              <input
                type="email"
      ...
      {googleLoading && (
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ color: '#d1d5db', fontSize: '14px' }}>Autenticando con Google...</span>
          </div>
        </div>
      )}
